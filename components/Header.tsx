    ...
    <header className="flex flex-wrap justify-between items-center px-4 py-2">
      ...
      <div className="flex w-full justify-between flex-wrap items-center">
        ...
        <div className="flex items-center space-x-4 mt-4 sm:mt-0 flex-1 md:flex-none">
          <Link
            href="/basket"
            className="flex-1 relative flex justify-center sm:justify-start sm:flex-none items-center space-x-2 bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded-md font-bold"
          >
